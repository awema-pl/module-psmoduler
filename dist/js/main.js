(function () {
    ...
    var psmodulerMixin = {
        ...
        beforeCreate() {
            this._config = Object.assign( _config, AWEMA.utils.object.get(AWEMA_CONFIG, 'psmoduler', {}) );
        }
    };
    ...
    var __vue_render__ = function() {
      ...
      return _c("div", [
        _c("p", [
          ...
          _c("code", [_vm._v("PSMODULER_EXAMPLE")]),
          _vm._v(" from "),
          _c("code", [_vm._v("psmoduler/resources/lang/**/js.php")]),
          _vm._v(": " + _vm._s(_vm.$lang.PSMODULER_EXAMPLE))
        ]),
        _vm._v(" "),
        _c(
          "button",
    ...
    __vue_render__._withStripped = true;
      ...
      var psmoduler = normalizeComponent_1(
    ...
    function install(Vue) {
        ...
        /Vue.component('psmoduler', psmoduler);
    ...
    var lang = {
        PSMODULER_EXAMPLE: 'psmoduler example',
    };
    ...
    const getters = {
        ...
        psmoduler: state => name => {
            return state[name]
        },

        isLoading: (state, getters) => name => {
            const psmoduler = getters.psmoduler(name);
            return psmoduler && psmoduler.isLoading
        },
    };
    ...
    const actions = {
        ...
        restoreData({ state }, { name }) {
            const psmoduler = state[name];
            return psmoduler.exampleData || 'example-data';
        },
